...
<div id="main" class="wrap">
	...
	<div class="main">
		<h2>添加商品</h2>
		<div class="manage">
				<sf:form id="productAdd" action="/product/addProduct"  enctype="multipart/form-data" modelAttribute="product"  method="post" onsubmit="return fun();">
				<table class="form">
					<tr>
						<td class="field">商品名称(*)：</td>
						<td><input type="text" class="text" name="p_name" value="" /><span></span></td>
					</tr>
                    <tr>
						<td class="field">描述：</td>
						<td><input type="text" class="text" name="discription" /></td>
					</tr>
					<tr>
						<td class="field">所属分类：</td>
						<td>
							<select name="pro_category.name" class="text">
								<option>选择分类</option>
								<c:forEach items="${list}" var="lis">
									<option value="${lis.name}">${lis.name}</option>
								</c:forEach>
							</select>
						</td>
					</tr>					
					<tr>
						...
						<td><input type="text" class="text_tiny" name="price" /> 元<span></span></td>
					</tr>
					
					<tr>
						<td class="field">库存(*)：</td>
						<td><input type="text" class="text_tiny" name="stock" /><span></span></td>
					</tr>
					<tr>
	...
	<script>
		...
		function fun() {
			...
			if(i!=null&&i!="" && i1!=null&&i1!="" && i2!=null&&i2!="" && i3!=null&&i3!=""
					&& t!=null&&t!="" && t!=null&&t!=""){
				a=true;
			}else {
				a=false;
